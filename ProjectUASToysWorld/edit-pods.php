...
$produk = select("SELECT * FROM shoppods WHERE id = $id")[0];
...
if(isset($_POST['submit'])){
    ...
    // query update data
    $query = "UPDATE shoppods SET proname ='$proname', deskripsi ='$deskripsi', harga ='$harga', gambar ='$gambar' WHERE id = $id";
...
<html lang="en">
    <head>
        ...
        <title>Edit Data Action Figure</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <header class="bg-dark py-4 ">
            <div class="container px-4 px-lg-5 my-6">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Admin Data Action Figure </h1>
                </div>
            </div>
        </header>
            ...
            <div class="container px-4 px-lg-5 mt-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-2 ">
                        <input type="text" class="form-control" id="proname" placeholder="Input Nama Produk" value="<?= $produk['proname']; ?>" name="proname" >
                    ...
                    <div class="form-floating mb-2 ">
                        <input type="text" class="form-control" id="deskripsi" placeholder="Input Nama Produk" value="<?= $produk['deskripsi']; ?>" name="deskripsi">
                    ...
                    <div class="form-floating mb-2 ">
                        <input type="number" class="form-control" id="harga" placeholder="Input Nama Produk" value="<?= $produk['harga']; ?>" name="harga">
                    ...
                    <div class="mb-2">
                        <input type="file" class="form-control" id="gambar" placeholder="Input Nama Produk" value="<?= $produk['gambar']; ?>" name="gambar">
                    </div>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Action Toys World</p></div>
        </footer>
        <!-- Bootstrap core JS-->
