...
$produk = select("SELECT * FROM homemods WHERE id = $id")[0];
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            <div class="container px-4 px-lg-5">
                ...
                font-family: 'Lexend', sans-serif;">
                    <img src="./images/logo.png" alt="" style="margin-right: 5px;">
                    Cloudy's
                </a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="shopMods.php">Mods</a></li>
                                <li><a class="dropdown-item" href="shopPods.php">Pods & AIO</a></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <header class="bg-dark py-5 mt-5">
            <div class="container px-4 px-lg-5 my-6">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">CLOUDY'S</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Easy Way to Vaping</p>
                </div>
            </div>
        </header>
