...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `shoppods`(`id`, `proname`, `deskripsi`, `harga`, `gambar`) VALUES (NULL,'$proname','$deskripsi','$harga','$gambar')";
...
function upload_file(){
    ...
    if (!in_array($extensifile, $extensifileValid)) {
        ...
        echo "<script>
                ...
                document.location.href = 'insert-pods.php';
            </script>";
        die();
    }
...
<html lang="en">
    <head>
        ...
        <title>Input Action Figure</title>
        <!-- Favicon-->
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="data-pods.php">Action Figure</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
