    ...
    <body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="data-pods.php">Action Figure World</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <header class="bg-dark py-4 ">
            <div class="container px-4 px-lg-5 my-6">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Admin Data Action Figure Anime</h1>
                </div>
            </div>
        </header>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-6">
                <a href="insert-pods.php" class="btn btn-primary mb-3" style="font-size: larger; font-weight:600;">Input Data</a>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="button" style="margin-left: 25px; padding-bottom: 15px;">
                                <a href="edit-pods.php?id=<?= $row['id']; ?>" class="btn btn-success" style="margin: 5px">Edit Data</a>
                                <a href="hapus-pods.php?id=<?= $row['id']; ?>" class="btn btn-danger" style="margin: 5px" onclick="return confirm(Ingin menghapus produk?);">Hapus Data</a>
                            </div>
                        </div>
                    </div>
                    <?php 
